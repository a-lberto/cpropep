...
/**********************************************************************
 * model_1                                                            *
 * modele de simulation de la fusée en tenant compte des paramètres   *
 * aérodynamiques                                                     *
 *********************************************************************/
...
//  double s = z[0];
     ...
     //et pour vérifier si le propulseur existe (shit)
...
//retourne la poussée de la fusée en fonction du temps, des paramètres de vol
//et des moteurs chargées
double T(double time) {
     double trel = 0;
     if (simptr->n_prop() == 0)
	  return 0.0;
...
/**********************************************************************
 * model_2                                                            *
 * modele de simulation simple de la fusée qui ne tient pas compte    *
